...
from influence_max.active_optimization.opt_model_module import StoJMLP

model_check = StoJMLP(
    n_hidden             = [50,50,50],
    get_latent_embedding = lambda x: x,
    n_noise              = 10,
    resample_size        = 10,
)
...
import influence_max.active_optimization.opt_model_module
reload(influence_max.active_optimization.opt_model_module)
from influence_max.active_optimization.opt_model_module import intermediate_grad_fn, mean_output
...
import influence_max.active_optimization.opt_model_module_pytorch
reload(influence_max.active_optimization.opt_model_module_pytorch)
from influence_max.active_optimization.opt_model_module_pytorch import  RntModelSimple
import influence_max.active_optimization.opt_model_module
reload(influence_max.active_optimization.opt_model_module)
from influence_max.active_optimization.opt_model_module import RntJMLPSingle, rnt_parameter_reconstruct, preprocess
import torch
